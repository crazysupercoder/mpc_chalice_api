...
from chalicelib.libs.purchase.core.values import OrderNumber, SimpleSku, Qty
from chalicelib.libs.purchase.core.cancellations import CancelRequest, CancelRequestStorageInterface
...
class CancelRequestStorageImplementation(CancelRequestStorageInterface):
    def __init__(self):
        self.__storage = _CancelRequestStorageElastic()
